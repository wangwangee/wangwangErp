...
<div class="container">
	<form action="enrollment" class="form-horizontal"  method ="post">
         <div class="col-sm-12 pt-3">	
            <div class="card">
                <div class="card-header card-header-primary">
                    <h4 class="card-title">  <img src="<%=request.getContextPath() %>/Image/design/map2.png" alt="거래처등록"/> &nbsp 거래처등록</h4>
			 ...
			 <div class="card-body">
				<div class="table-responsive">
			  		<table class="table">
						...
						<tr>
							<th>경도</th>
							<td><input type ="text" name ="longitude"value =<%=longitude%> required   readonly /></td>
						</tr>			
						
						 
						<tr style="line-height:32px;">
							<td  colspan="16" style ="text-align: center;margin: 0 auto;" >
								<input type ="submit"  class="btn btn-dark"  value ="거래처 등록"/> 
								<input type ="button"  class="btn btn-dark" value ="돌아가기"  onclick="location.href='/map/accountRecord'"/>
							</td>
						</tr>	
